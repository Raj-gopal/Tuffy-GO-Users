...
String mapkey = Platform.isAndroid ?'AIzaSyAnrBE5cCiSPYGAzd0fzfH2fOF2BqEDh48' : 'AIzaSyAnrBE5cCiSPYGAzd0fzfH2fOF2BqEDh48';
String mapType = '';
...
createProRequest() async {
  dynamic result;
  final driver = driverDetails[choosenVehicle]['drivers'][choosenDriver];
  try {
