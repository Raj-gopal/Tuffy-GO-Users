...
class _InvoiceState extends State<Invoice> {
  ...
  void _setupMarkersAndPolyline() async {
    LatLng pickupLocation = LatLng(userRequestData['pick_lat'], userRequestData['pick_lng']);
    LatLng dropLocation = LatLng(userRequestData['drop_lat'],userRequestData['drop_lng']);
    ...
    PolylineResult result = await PolylinePoints().getRouteBetweenCoordinates(
      'AIzaSyBJtwIWhx0LszJSBOwDBvHoOMmPtjNKTDE', // Replace with your Google Maps API key
                                  ...
                                  Container(
                                    ...
                                    child: GoogleMap(
                                      initialCameraPosition: CameraPosition(
                                        target: LatLng(userRequestData['pick_lat'], userRequestData['pick_lng']),
                                        zoom: 14,
                                      ),
                                      markers: _markers,
