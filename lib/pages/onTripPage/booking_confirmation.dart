...
import '../../functions/functions.dart' hide PointLatLng;
...
class _BookingConfirmationState extends State<BookingConfirmation>
  ...
  // databaseRef.child('requests').get().then((snapshot) {
  // // Directly access and use the snapshot data
  // final String requestId = snapshot.child('request_id').value.toString();
  // final DatabaseReference childRef = databaseReference.child(requestId);
...
//  // Initialize references to Firebase Database
//   final DatabaseReference _notesReference = FirebaseDatabase.instance.ref().child('notes');
//   final DatabaseReference _requestsReference = FirebaseDatabase.instance.ref().child('requests');
//
...
//
//     _notesReference.push().set({
//       'note': noteText,
//       'date': dateTime,
//     }).then((_) {
//       print('Note added successfully to notes.');
//     }).catchError((error) {
//       print('Failed to add note to notes: $error');
//     });
//   }
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    TextButton(
                      ...
                      onPressed: () async {
                        // Reference to the 'requests/note' path in the database
                        DatabaseReference ref = FirebaseDatabase.instance.ref('requests').child('note');

                        // Setting the note data
                        await ref.set({'note': noteController.text});
                                                                            ...
                                                                            child: InkWell(
                                                                              onTap: () async {
                                                                                ...
                                                                                Future.delayed(Duration(seconds: 3), () {
                                                                                  setState(() {
                                                                                    note = 1; // Change the note to 1 after some delay
                                                                                  });

                                                                                  // Check the condition and show the dialog if the condition is met
                                                                                  if (note == 1) {
                                                                                    _showAddNoteDialog();
                                                                                  }
                                                                                });
                                                          ...
                                                          InkWell(
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child: Row(
                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                //     color: Colors.white.withOpacity(.1),
                                                                                //   ),
                                                                                //   child: Icon(Icons.receipt_long_rounded, color: Colors.white60),
                                                                                // ),
                                                                              ],
                                                                            ),
                                                                          ),
                                                                          ...
                                                                          Expanded(
                                                                            child: ListView.separated(
                                                                              ...
                                                                              separatorBuilder: (BuildContext context, int index) {
                                                                                return SizedBox(height: 16); // Adjust the height according to your preference
                                                                              },
                                                                                ...
                                                                                return Column(
                                                                                  ...
                                                                                  children: [
                                                                                    ListView.builder(
                                                                                      ...
                                                                                      itemCount: driverDetails[index]['drivers'].length,
                                                                                      itemBuilder: (BuildContext context, int driverIndex) {


                                                                                        final driver = driverDetails[index]['drivers'][driverIndex];
                                                                                        late String number =  driver['car_number'];
                                                                                        late String name =  driver['name'];
                                                                                        if(searchController.text.isEmpty ){


                                                                                          return Container(

                                                                                              child: driverDetails[index]['name'] == 'Mini'?
                                                                                              Container(

                                                                                                margin: EdgeInsets.symmetric(vertical: 8), // Add margin to create space between items
                                                                                                decoration: BoxDecoration(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Text(
                                                                                                            'INR' + ' ' +   driverDetails[index]['total'].toStringAsFixed(2),
                                                                                                            style: GoogleFonts.notoSans(color: Colors.white60),
                                                                                                          ),
                                                                                                        ],
                                                                                                      ),
                                                                                                      Text(
                                                                                                        driverDetails[index]['name'],
                                                                                                        style: TextStyle(
                                                                                                          color: Colors.white60,
                                                                                                          fontSize: 16,
                                                                                                          fontWeight: FontWeight.bold,
                                                                                                      ...
                                                                                                      Container(
                                                                                                        ...
                                                                                                        child: driverDetails[index]['name'] == 'Mini'?  StarRating(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          SizedBox(
                                                                                                            ...
                                                                                                            child: ElevatedButton(
                                                                                                              ...
                                                                                                              onPressed: () async {
                                                                                                                setState(() {
                                                                                                                  choosenVehicle = index;
                                                                                                                  choosenDriver = driverIndex;
                                                                                                                });
                                                                                                                // Handle button press
                                                                                                                          ...
                                                                                                                          child: Column(
                                                                                                                            ...
                                                                                                                            children: [
                                                                                                                              Container(
                                                                                                                                ...
                                                                                                                                child: Image.network(
                                                                                                                                  driver['profile_picture'],fit: BoxFit.cover, // URL of the image to be displayed
                                                                                                                                ),
                                                                                                                              ),
                                                                                        ...
                                                                                        } else if(name.toLowerCase().contains(searchController.text.toLowerCase()) || number.toLowerCase().contains(searchController.text.toLowerCase())){
                                                                                          return Container(
                                                                                                  ...
                                                                                                  child: Column(
                                                                                                    ...
                                                                                                    children: [
                                                                                                      Row(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          Text(
                                                                                                            name,
                                                                                                            style: GoogleFonts.notoSans(
                                                                                                              color: (name.toLowerCase().contains(searchController.text.toLowerCase())) ? Colors.blue : Colors.white60,
                                                                                                              fontSize: 24,
                                                                                                              fontWeight: FontWeight.bold,
                                                                                                            ),
                                                                                                          ),
                                                                                                      ...
                                                                                                      Text(
                                                                                                        driver['car_number'],
                                                                                                        style: TextStyle(
                                                                                                          color:(number.toLowerCase().contains(searchController.text.toLowerCase())) ? Colors.blue : Colors.white60,
                                                                                                          fontSize: 16,
                                                                                                          fontWeight: FontWeight.bold,
                                                                                                        ),
                                                                                                      ),
                                                            ...
                                                            child: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                ...
                                                                boxShadow: [
                                                                  BoxShadow(
                                                                    color: (isDarkTheme == true) ? Colors.white.withOpacity(0.1) : Colors.black.withOpacity(0.21),
                                                                    spreadRadius: 1.5,
                                                                    blurRadius: 1.5,
                                                                  )
                                                                ],
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Button(
                                                            ...
                                                            text: (confirmRideLater == true || isOutStation) ? languages[choosenLanguage]['text_schedule'] : 'Quick Any'),
                                                      ],
                                                    ),
                                                  ),
                                                ],
                                      ...
                                      child: Column(
                                        children: [
                                          SizedBox(
                                            width: media.width * 0.9,
                                            child: MyText(
                                              text: 'Sending Details to Captains....',
                                              size: media.width *
                                                  fourteen,
                                              fontweight:
                                              FontWeight.bold,
