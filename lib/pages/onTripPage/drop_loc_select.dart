                                                ...
                                                if (dropAddressConfirmation !=
                                                  ...
                                                  if (choosenTransportType ==
                                                    ...
                                                    if (widget.from != null &&
                                                      ...
                                                      // Get the index of the drop location
                                                      int dropIndex = addressList.indexWhere((location) => location.type == 'drop');

                                                      if (dropIndex != -1) {
                                                        // Insert the new location after the drop location
                                                        var newLocation = AddressList(
                                                          id: (addressList.length + 1).toString(),
                                                          type: 'new', // You may need to adjust this based on your implementation
                                                        ...
                                                        addressList.insert(dropIndex + 1, newLocation);
                                                      }
                                                    }
